...
import gotaAguaPorcentaje from '../src/assets/gota-de-agua2.png';
...
export function TiempoReal() {
    ...
    const imagenHumedad = humedadActual !== 0 ? gotaAgua : gotaAguaNegra;
    ...
    return (
        <>
            ...
            <div className="graficas">
                ...
                <div className="grafica">
                    <Line data={{
                        labels: data.humidity.map((_, index) => index),
                        datasets: [{
                            label: 'Humedad',
                            data: data.humidity,
            ...
            <div className="grafica">
                ...
                <p className='TextHumedad'>Humedad: {humedadActual}%</p>
            </div>

                <div className="grafica doughnut-container">
                    <h1>Nivel de Agua del Tanque</h1>
                    <p>Porcentaje de agua: </p> <p>{data.waterTankLevel[data.waterTankLevel.length - 1]}%</p>
                    <img className='gota' src={gotaAguaPorcentaje} alt="Nivel del tanque" />
                </div>
            </div>
